...
<!-- <div class="equation" align="center" data-raw-text="\sigma^2 = \frac{1}{N} \sum_{i=0}^{N-1} (x_i - \mu)^2" data-equation="eq:population_variance">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@f85af87fd916af053698e5c33740948c95161155/lib/node_modules/@stdlib/stats/strided/dmeanvar/docs/img/equation_population_variance.svg" alt="Equation for the population variance.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{N} \sum_{i=0}^{N-1} x_i" data-equation="eq:population_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@f85af87fd916af053698e5c33740948c95161155/lib/node_modules/@stdlib/stats/strided/dmeanvar/docs/img/equation_population_mean.svg" alt="Equation for the population mean.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="s^2 = \frac{1}{n-1} \sum_{i=0}^{n-1} (x_i - \bar{x})^2" data-equation="eq:unbiased_sample_variance">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@f85af87fd916af053698e5c33740948c95161155/lib/node_modules/@stdlib/stats/strided/dmeanvar/docs/img/equation_unbiased_sample_variance.svg" alt="Equation for computing an unbiased sample variance.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\bar{x} = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:sample_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@f85af87fd916af053698e5c33740948c95161155/lib/node_modules/@stdlib/stats/strided/dmeanvar/docs/img/equation_sample_mean.svg" alt="Equation for the sample mean.">
    <br>
</div> -->
...
```javascript
dmeanvar = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmeanvar@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dmeanvar/tags). For example,

```javascript
dmeanvar = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmeanvar@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dmeanvar = require( 'path/to/vendor/umd/stats-strided-dmeanvar/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmeanvar@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dmeanvar.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dmeanvar

[test-image]: https://github.com/stdlib-js/stats-strided-dmeanvar/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-dmeanvar/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dmeanvar/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dmeanvar?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dmeanvar.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dmeanvar/main
...
[branches-url]: https://github.com/stdlib-js/stats-strided-dmeanvar/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dmeanvar/main/LICENSE
